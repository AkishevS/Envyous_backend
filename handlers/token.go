...
// BonusHandler issues a daily bonus of 100 coins if 8 hours passed since last claim.
...
// TransferHandler transfers balance from one user to another by username.
...
// HistoryHandler returns transaction history for a user.
